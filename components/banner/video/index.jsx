...
function BannerVideo({ videoUrl="/video/video01.mp4", content = [], bannerTitle }) {
  return <>
    <section className={style.banner}>
      <video src={videoUrl} loop autoPlay muted style={{
        width: "100%",
      }}></video>
